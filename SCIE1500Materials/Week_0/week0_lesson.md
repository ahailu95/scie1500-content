...
## Act I: Understanding Systems — Chapter 0

> *"Before you can model the world, you need to speak its language. Mathematics is that language."*

---

## Theme: "The Scientist's Toolkit"

**Science Context:** Number systems, algebraic manipulation, Python basics, function notation

**Learning Outcomes:** At the end of this week you should be able to:

1. Identify and work with real number sets ($\mathbb{N}, \mathbb{Z}, \mathbb{Q}, \mathbb{R}$)
2. Apply BODMAS/order of operations correctly in scientific calculations
3. Manipulate exponents, radicals, and algebraic expressions
4. Solve linear and quadratic equations and linear inequalities
5. Use scientific notation and perform unit conversions
6. Interpret and apply function notation $f(x)$
7. Write interval notation for domains and ranges
8. Use Python for basic calculations and plotting

---

> **📓 About "Try it in Python" boxes:** Throughout this lesson, these boxes reference specific code examples by ID — e.g. **W0-CS03** means *Week 0, Code Snippet 3*. Find the matching code under **Notes → Python Code Snippets** for this week; each entry there is labelled with its ID.
...
> **📓 Try it in Python**
>
> - **W0-CS01** — *BODMAS - Order of Operations*: Verify operator precedence with a runnable example.
> - **W0-CS12** — *Comparison and Logical Operators*: Combine BODMAS with `and` / `or` to evaluate conditions.
>
...
| Power    | $\sqrt{a^2} = \lvert a \rvert$                 | $\sqrt{(-3)^2} = 3$                       |
...
> **📓 Try it in Python**
>
> - **W0-CS02** — *Exponentiation*: Compare `**`, `math.pow`, and `math.sqrt` on the same values.
> - **W0-CS11** — *Math Module Constants and Functions*: Use `math.pi`, `math.e`, `math.log` for richer expressions.
>
> Find these under **Notes → Python Code Snippets** for this week.
...
> **📓 Try it in Python**
>
> - **W0-CS03** — *Scientific Notation*: Convert between `1.5e6` and decimal form, and apply unit conversions.
> - **W0-CS13** — *Floor Division and Modulus*: See how `//` and `%` show up in unit conversions and time calculations.
>
> Find these under **Notes → Python Code Snippets** for this week.
...
> **📓 Try it in Python**
>
> - **W0-CS04** — *Defining and Evaluating Functions*: Use `def` to encode $f(x) = 2x + 3$ exactly as written on paper.
> - **W0-CS05** — *Quadratic Function*: Evaluate $f(x) = x^2 - 4x + 3$ and inspect its sign at chosen points.
>
> Find these under **Notes → Python Code Snippets** for this week.
...
## 11. Week 0 Lab: Python Basics

The lab notebook this week introduces you to Python through hands-on exercises. Here's what you'll cover:

### Section 0: Your First Python Command
- Using Python as a calculator: `+`, `-`, `*`, `/`, `**`
- **Activity 1:** Evaluate two numerical expressions

### Section 1: Storing Values in Variables
- Assigning values with `=`
- Variable naming rules: start with a letter, case-sensitive, use descriptive names
- Worked example: Fahrenheit-to-Celsius temperature conversion

### Section 2: The `print()` Function
- Printing numbers, text (strings), and combinations of both

### Section 3: Python Syntax Essentials
- Case sensitivity
- Comments (`#`)
- Indentation for `if`/`else` blocks
- **Activity 2:** Find and fix two bugs in a short program

### Section 4: Python Data Types
- `int`, `float`, `str`, `bool`
- Strings and string concatenation
- Lists: indexing and `len()`
...
- Logical: `and`, `or`, `not`
- Operator precedence
- **Activities 3, 4:** Predict the result of logical expressions; evaluate an expression by hand and check it

### Section 6: Getting Help
- Using `help()` to read a function's documentation

### Section 7: Importing Modules
- The `math` module: `math.sqrt()`, `math.pi`, `math.sin()`
- The `numpy` module: arrays and vectorised operations (apply a formula to every element at once)
- `np.linspace()` for evenly spaced values
- 2-D arrays and `.transpose()`
- **Activity 5:** Create arrays with `linspace`

### Section 8: Plotting with `matplotlib`
- Basic line plots: format strings, titles, axis labels, grids
- Plotting real data (leaf area vs. leaf weight)
- Plotting a mathematical function
- **Activities 6, 7:** Plot the leaf area data; plot a parabola

> **📓 Try it in Python**
>
> Build the lab plotting workflow piece by piece:
> - **W0-CS06** — *Import Statements*: The standard `numpy` / `matplotlib.pyplot` setup used in every notebook.
> - **W0-CS07** — *Creating Arrays with NumPy*: Generate evenly spaced $x$-values with `np.linspace`.
> - **W0-CS08** — *Array Operations*: Apply vectorised arithmetic to compute $y$-values.
> - **W0-CS09** — *Basic Plotting*: Draw a labelled line plot with `plt.plot`.
> - **W0-CS10** — *Scatter Plot with Formatting*: Compare scatter and line styles.
> - **W0-CS14** — *2D Arrays and Transpose*: Preview matrix operations used later in Week 12.
>
> Find these under **Notes → Python Code Snippets** for this week.
