...
> **📓 About "Try it in Python" boxes:** Throughout this lesson, these boxes reference specific code examples by ID — e.g. **W12-CS03** means *Week 12, Code Snippet 3*. Find the matching code under **Notes → Python Code Snippets** for this week; each entry there is labelled with its ID.
...
> **📓 Try it in Python**
>
> Solve and visualise systems of equations:
> - **W12-CS01** — *Simultaneous Equations with NumPy*: Use `np.linalg.solve`.
> - **W12-CS02** — *Two Lines Intersection*: Plot lines and mark the solution point.
>
...
> **📓 Try it in Python**
>
> Find market equilibrium computationally:
> - **W12-CS03** — *Market Equilibrium*: Solve $Q_d = Q_s$ and plot supply/demand curves.
>
> Find these under **Notes → Python Code Snippets** for this week.
...
> **📓 Try it in Python**
>
> Compute consumer and producer surplus two ways:
> - **W12-CS04** — *CS / PS via Triangle Formulas*: Quick area shortcut.
> - **W12-CS05** — *CS / PS via Integration*: General method using `scipy.integrate.quad`.
>
> Find these under **Notes → Python Code Snippets** for this week.
...
## 5. Solving LP Graphically: The Diet Problem

### 5.1 Problem Setup

**Scenario:** Design a minimum-cost diet combining two foods to meet nutritional requirements.
...
**Part (d):** If Food I costs $5 instead of $2, what changes?
...
> **📓 Try it in Python**
>
> Solve linear programs graphically and numerically:
> - **W12-CS06** — *LP Feasible Region*: Shade the constraint set.
> - **W12-CS07** — *Corner Points Evaluation*: Test each vertex of the feasible region.
> - **W12-CS08** — *Sensitivity Analysis*: How does the optimum shift with parameter changes?
> - **W12-CS09** — *LP with `scipy.optimize.linprog`*: Production-grade LP solver.
>
> Find these under **Notes → Python Code Snippets** for this week.
...
> - **W12-CS10** — *Complete LP Dashboard*: Interactive end-to-end LP visualisation.
>
> Find these under **Notes → Python Code Snippets** for this week.
