...
## Act I: Understanding Systems — Chapter 2

> *"Exponential growth is not intuitive — but once you see it in data, you cannot unsee it."*
...
> **📓 About "Try it in Python" boxes:** Throughout this lesson, these boxes reference specific code examples by ID — e.g. **W2-CS03** means *Week 2, Code Snippet 3*. Find the matching code under **Notes → Python Code Snippets** for this week; each entry there is labelled with its ID.
...
| 10 hours | 1,073,741,824 bacteria (1.07 billion) |
...
> **📓 Try it in Python**
>
> - **W2-CS01** — *Setup: Import Libraries*: Standard imports for every example below.
> - **W2-CS04** — *Exponential Growth vs Decay*: Plot $b^x$ for $b > 1$ and $0 < b < 1$ side-by-side.
> - **W2-CS15** — *Population Growth Rates Comparison*: See linear vs exponential trajectories at a glance.
>
...
> **📓 Try it in Python**
>
> - **W2-CS02** — *The Number e: Limit Definition*: Watch $(1 + 1/n)^n$ approach $e$ as $n$ grows.
> - **W2-CS03** — *Why e? Derivative Investigation*: Numerically verify that $\tfrac{d}{dx}e^x = e^x$.
>
> Find these under **Notes → Python Code Snippets** for this week.
...
> **📓 Try it in Python**
>
> - **W2-CS05** — *Bacteria Growth Example*: Project a population growing at a fixed rate per hour.
> - **W2-CS13** — *Acacia Tree Growth Model*: A real ecology example used in the Week 2 lab.
>
> Find these under **Notes → Python Code Snippets** for this week.
...
> **📓 Try it in Python**
>
> - **W2-CS06** — *Logarithm as Inverse of Exponential*: Confirm $\log_b(b^x) = x$ visually.
> - **W2-CS07** — *Solving Exponential Equations*: Use logs to solve for unknown exponents.
>
> Find these under **Notes → Python Code Snippets** for this week.
...
> **📓 Try it in Python**
>
> - **W2-CS08** — *The 70/r Rule for Doubling Time*: Verify the rule of thumb against exact log calculations.
> - **W2-CS09** — *Geometric Sequence Visualization*: Plot the discrete-time analogue of exponential growth.
> - **W2-CS10** — *Geometric Series Sum*: Compute $\sum a r^n$ in closed form and term-by-term.
> - **W2-CS11** — *Compound Interest Calculator*: Apply geometric growth to finance.
>
> Find these under **Notes → Python Code Snippets** for this week.
...
> **📓 Try it in Python**
>
> - **W2-CS12** — *Probability Function (Logistic-type)*: A non-linear example used to model risk.
> - **W2-CS14** — *Function Composition Demo*: How $f(g(x))$ behaves for exponential and log pairs.
>
> Find these under **Notes → Python Code Snippets** for this week.
